...
fruit_fly_lifespan <- 0.3
giraffe_lifespan <- 39.5
...
king_penguin_lifespan > fruit_fly_lifespan 
king_penguin_lifespan > giraffe_lifespan 

```

```{r}
fruit_fly_lifespan > giraffe_lifespan
fruit_fly_lifespan > king_penguin_lifespan

```

```{r}
giraffe_lifespan > king_penguin_lifespan
giraffe_lifespan > fruit_fly_lifespan
...
```{r}
theanilmails <- c("king_penguin","fruit_fly", "giraffe")
lifespans <- c(king_penguin_lifespan, fruit_fly_lifespan, giraffe_lifespan)
...
```{r}
humanconversation <- 122.5 / lifespans
humanconversation
...
```{r}
king_penguin_to_human_years <- function(animalyears, human_lifespan, king_penguin_lifespan){
    animal_to_human_years <- (human_lifespan/king_penguin_lifespan)*animalyears
    return(animal_to_human_years)
}
...
```{r}
king_penguin_to_human_years(5,122.5, 26)
